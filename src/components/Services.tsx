...
const services = [
  ...
  },
  {
    ...
    desc: "Ved en chakra-clairvoyance stilles der ind på dine chakraer i kroppen. \n\n\nJeg stiller ind på hvordan der kan arbejdes med at skabe mere balance i krop og sjæl. \n\n\nLettere healing og vejrtrækningsøvelser kan forekomme.",
    duration: "45 min",
    price: "499 kr.",
    icon: "◎",
  },
  ...
  },
  {
    ...
    desc: "Måske ved du ikke hvordan du skal gribe din spiritualitet an? Det kan være rart og hyggeligt, at blive introduceret til den spirituelle verden sammen med gode veninder. Et arrangement kan indeholde orakel/englekort med/uden clairvoyant budskab, En kortere clairvoyance for hver deltager (maks. 6 personer), en guidet meditation eller drømmerejse, et forløb med intuitiv maling/tegning eller et foredrag om den spirituelle verden og dens symboler. \n\n\n Jeg holder afholder spirituelle arrangementer og foredrag for mindre grupper. Kontakt mig gerne, så vi kan aftale indhold og pris.",
    duration: "",
    price: "Kontakt",
    icon: "✺",
  },
